<template>
  <page-header>
    <template slot="heading">
      ...
      <br>
      <button v-if="!$auth.loggedIn" @click="$auth.loginWith('auth0')">Sign in or Register to get started</button>
      <nuxt-link v-if="$auth.loggedIn" to="dashboard">Check out our progress so far?</nuxt-link>
    </template>
  </page-header>
</template>
